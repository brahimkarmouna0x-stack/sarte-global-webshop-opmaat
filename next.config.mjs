...
const nextConfig = {
  ...
  async redirects() {
    return [
      ...
      { source: "/shopify-webshop-laten-maken", destination: "/shopify-webshop-op-maat", permanent: true },
      { source: "/woocommerce-webshop-laten-maken", destination: "/woocommerce-webshop-op-maat", permanent: true },
      { source: "/webapp-laten-maken", destination: "/ecommerce-oplossingen", permanent: true },
      ...
      { source: "/services/ecommerce", destination: "/webshop-op-maat", permanent: true },
