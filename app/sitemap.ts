...
export default function sitemap(): MetadataRoute.Sitemap {
  const staticPages: MetadataRoute.Sitemap = [
    ...
    { url: `${SITE_URL}/webshop-op-maat`, lastModified: LAST_MODIFIED, changeFrequency: "monthly", priority: 0.95 },
    { url: `${SITE_URL}/shopify-webshop-op-maat`, lastModified: LAST_MODIFIED, changeFrequency: "monthly", priority: 0.9 },
    { url: `${SITE_URL}/woocommerce-webshop-op-maat`, lastModified: LAST_MODIFIED, changeFrequency: "monthly", priority: 0.9 },
    { url: `${SITE_URL}/ecommerce-oplossingen`, lastModified: LAST_MODIFIED, changeFrequency: "monthly", priority: 0.85 },
    { url: `${SITE_URL}/webshop-laten-maken`, lastModified: LAST_MODIFIED, changeFrequency: "monthly", priority: 0.85 },
    { url: `${SITE_URL}/b2b-webshop`, lastModified: LAST_MODIFIED, changeFrequency: "monthly", priority: 0.85 },
    { url: `${SITE_URL}/b2c-webshop`, lastModified: LAST_MODIFIED, changeFrequency: "monthly", priority: 0.85 },
