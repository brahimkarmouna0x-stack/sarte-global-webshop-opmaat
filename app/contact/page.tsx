...
const PAGE_TITLE = "Contact | Webshop Op Maat Experts";
const PAGE_DESC =
  "Neem contact op met Sarte Global, het team achter webshop-opmaat.nl. E-mail of WhatsApp — we reageren binnen één werkdag.";
