...
export const SERVICES = [
  ...
  },
  {
    ...
    tagline:
      "Maatwerk webshops die verkopen — modern, snel en gebouwd om te converteren.",
    description:
      "Shopify, WooCommerce of maatwerk: een webshop op maat die past bij jouw producten, klanten en groeiplannen.",
    href: "/webshop-op-maat",
    icon: "cart",
    heroEyebrow: "Dienst · Webshop op maat",
    heroTitleLead: "Een webshop op maat die",
